...
```js
const currentTarget$ = Rx.Observable.fromEvent(document, "click")
  .pluck("currentTarget"); // observable
...
![observable](observable_detail.png)
...
![subscription](subscription_detail.png)
...
![rxjs 4가지 개념](rxjs-structure1.png)
