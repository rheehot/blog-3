...
{% asset_img pr-by-commit.png %}
코드 리뷰가 훨씬 편해요.
[{% asset_img demo.gif %}](https://github.com/Microsoft/VSCODE-pull-request-github/blob/master/.readme/demo.gif?raw=true)
...
[{% asset_img vscode-live.png %}](https://code.visualstudio.com/assets/blogs/2017/11/15/vs-code-ls-session2.png)
